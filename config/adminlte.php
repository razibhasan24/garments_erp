    ...
    */
    ...
    'plugins' => [
        ...
        'menu' => [
            ...
            [
                'text' => 'Sewing Production',
                'url' => 'sewing-production',
                'icon' => 'fas fa-fw fa-industry',
                'can' => 'manage-sewing-production',
            ],
            [
                'text' => 'Quality Control',
                'icon' => 'fas fa-fw fa-check-circle',
                'can' => 'manage-qc-inline',
                'submenu' => [
                    ['text' => 'Inline QC', 'url' => 'qc/inline'],
                    ['text' => 'Endline QC', 'url' => 'qc/endline'],
                    ['text' => 'Final Inspection (AQL)', 'url' => 'qc/final'],
                ],
            ],
            ['header' => 'INVENTORY'],
            [
            ...
            [
                ...
                'submenu' => [
                    ...
                    ['text' => 'Roles & Permissions', 'url' => 'roles'],
                ],
            ],
            [
                'text' => 'Audit Logs',
